...
source as ( select * from {{ source('NHL', 'shots') }} ),
...
casted as (
    ...
    select
        ...
        safe_cast(datetime_utc as timestamp) as shot_utc,
        ...
        safe_cast(shot_distance as float64) as shot_distance,
        safe_cast(shot_angle as float64) as shot_angle,
